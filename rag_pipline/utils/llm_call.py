...
def call_llm(prompt: str, session_id: str, metadata: Optional[Dict[str, Any]] = None) -> str:
    """
...
def generate_description(content_type: str, data: Dict[str, Any], session_id: str = "desc_gen") -> str:
